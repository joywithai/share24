  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={onSubmit} className="space-y-5">
        {/* Route and lock first, with the "Create share" button right below
            them — the same order as /create/file, so the button stays in view
            instead of sitting under the tall editor. */}
        <Card>
          <CardContent className="p-5">
            ...
            <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-line pt-5">
              <p className="text-xs text-sub">
                {code.trim().length === 0
                  ? 'Write or paste your code below — then create the share.'
